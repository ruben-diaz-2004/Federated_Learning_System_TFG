...
def main():
    ...
    raw_data_path = {
        ...
        "train_config": {
            ...
            "patience": 50, "num_classes": 2, "save_path": "best_resnet50_syft.pth",
        }
    }
    ...
    def remote_preprocessing_and_training(raw_data_dict):
        ...
        try:
            ...
            save_path   = cfg.get("save_path",    "best_resnet50_syft.pth")
    ...
    # torch.save(model_weights, "weights_round_2.pth")
